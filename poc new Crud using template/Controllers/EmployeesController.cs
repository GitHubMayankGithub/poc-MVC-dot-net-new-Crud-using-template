...
using poc_new_Crud_using_template;

namespace poc_new_Crud_using_template.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,FirstName,LastName,Email,AddressId,Code")] Employee employee)
        {
